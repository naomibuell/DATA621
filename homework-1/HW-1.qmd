...
This training dataset contains `r nrows` rows and `r ncols` features, and is `r perc_complete` percent complete. The variables with the highest rates of missingness are:
...
corrplot(moneyball_train_cor, method = "circle", type = "upper", tl.cex = 0.7, sig.level = 0.05, insig = "blank", addCoef.col = "black", number.cex = 0.9)
```
