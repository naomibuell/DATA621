...
We performed exploratory data analysis to understand the distribution of our outcome variable (prevalence of pain reliever misuse) and the relationships between our predictors and the outcome. We visualized the distribution of the outcome variable across states and years, and we examined correlations between predictors and the outcome variable.
