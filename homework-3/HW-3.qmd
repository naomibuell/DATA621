...
Completed
:::
For the crime data used in Homework 3, the first step in data preparation was to check whether any variables contained missing values. Unlike the older baseball assignment text currently carried over in the draft, this crime data set does not contain missing values in either the training or evaluation files. Therefore, no imputation or missingness flag variables were needed.
